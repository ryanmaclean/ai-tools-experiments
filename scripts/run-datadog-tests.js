 ...
 * 
 * This script runs Datadog synthetic tests for both API and browser tests,
 * reporting results to Datadog and handling test failures.
 */
...
function runTests(type, env) {
  ...
  try {
    const testDir = path.join(__dirname, '..', 'tests', 'datadog-synthetic', type);
